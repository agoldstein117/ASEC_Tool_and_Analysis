...
new_names={"A_EXPLF":'Unempoyment Status','A_LFSR':'In Labor Force?','UC_YN': 'Received UIB','UC_VAL':'UIB Amount','A_WKSLK':'Duration of unemployment','NXTRES':'Moving Status','PRDTRACE':'Race','A_SEX':'Sex'}
...
grouped2=final_data.groupby('Moving Status').size().sort_values()

print(grouped2) 


print(new_trimmed['Received UIB'].value_counts()) 

final_data.to_csv('final_data.csv')
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 11 13:18:26 2022
